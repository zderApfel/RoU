...
When a Merc is activated, that means that, when ready, a new exploration phase will start where you take control of the merc. Items collected by you still go to the collective inventory accessible from the Hideout

### Passive Activites

During an exploration phase where they're not doing anything, you can select a passive activity for the merc to do:

* Weightlifting = 3% chance to increase Strength/Health stat
* Target Practice = 3% chance to increase Shooting stat
* Cardio = 3% chance to increase Agility/Health
* Casino = Chance to win money. Scales with agility/charisma
* Casino (cheating) = Higher chance to win money, but also with a chance to be [detained](#detained). Scales with Agility/Charisma
* Theft = Chance to steal some extra items, but with a chance to be detained. Scales with Agility/Charisma

### Specializations

Sometimes the merc you hired on is particularly good at a certain set of skills, this means they can be given a special task during an exploration phase that will provide you with some sort of passive benefit for the duration of that phase. 

## Combat

In combat you can utilize both melee weapons and ranged weapons. Each of their own unique points
...
Death is permanent in this game. However, the game does not end unless the main character (you) die. Which means that getting your first few mercs is essential for a successful run of this game. 
...
* Cowardice (hidden): The liklihood that the NPC will flee from combat when damaged or threatened. *HINT: This increases significantly when an NPC is armed.*
